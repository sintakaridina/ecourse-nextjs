              ...
              <ul className="wsmenu-list">
                    ...
                    <div className="container-fluid">
                      <div className="row">
                        ...
                        <ul className="col-lg-6 col-md-12 col-xs-12 link-list left-link-list">
                          <li>
                            <Link legacyBehavior href="about">About Us Page</Link>
                          </li>
                          <li>
                          ...
                          <li>
                            <Link legacyBehavior href="courses-list">Courses Listing</Link>
                          </li>
                          <li>
                            <Link legacyBehavior href="course-details">Course Details</Link>
                          </li>
                          <li>
                            <Link legacyBehavior href="teachers-list">Teachers Listing</Link>
                          </li>
                          <li>
                            <Link legacyBehavior href="teacher-profile">Teacher Profile</Link>
                          </li>
                        </ul>
                        {/* Links */}
                        <ul className="col-lg-6 col-md-12 col-xs-12 link-list">
                          ...
                          <li>
                            <Link legacyBehavior href="pricing">Pricing Plans Page</Link>
                          </li>
                          <li>
                            <Link legacyBehavior href="reviews">Reviews Page</Link>
                          </li>
                          <li>
                            <Link legacyBehavior href="faqs">FAQs Page</Link>
                          </li>
                          <li>
                            <Link legacyBehavior href="blog-listing">Blog Listing</Link>
                          </li>
                          <li>
                            <Link legacyBehavior href="single-post">Single Post</Link>
                          </li>
                          <li>
                            <Link legacyBehavior href="contacts">Contacts Page</Link>
                          </li>
                        </ul>
                      </div>
                    </div>
                ...
                <li onClick={() => activeFun("Categories")}>
                  ...
                  <ul className={`sub-menu ${activeLi("Categories")}`}>
                    <li>
                      <Link legacyBehavior href="courses-list">Development</Link>
                    </li>
                    <li>
                      <Link legacyBehavior href="courses-list">Finance &amp; Accounting</Link>
                    </li>
                    <li>
                      <Link legacyBehavior href="courses-list">IT &amp; Software</Link>
                    </li>
                    <li>
                      <Link legacyBehavior href="courses-list">Office Productivity</Link>
                    </li>
                    <li>
                      <Link legacyBehavior href="courses-list">Photography</Link>
                    </li>
                    <li>
                      <Link legacyBehavior href="courses-list">Math &amp; Science</Link>
                    </li>
                    <li>
                      <Link legacyBehavior href="courses-list">Languages</Link>
                    </li>
                    <li>
                      <Link legacyBehavior href="courses-list">Marketing</Link>
                    </li>
                    <li>
                      <Link legacyBehavior href="courses-list">Health &amp; Fitness</Link>
                    </li>
                  </ul>
                </li>{" "}
                {/* END DROPDOWN MENU */}
                ...
                {/* SIMPLE NAVIGATION LINK */}
                <li className="nl-simple">
                  <Link legacyBehavior href="blog-listing">Blog</Link>
                </li>
                {/* SIMPLE NAVIGATION LINK */}
                <li className="nl-simple">
                  <Link legacyBehavior href="contacts">Contacts</Link>
                </li>
                {/* DROPDOWN MENU */}
                {headerBtn ? (
